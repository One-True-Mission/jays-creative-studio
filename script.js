/* ============================================================
   JAY'S CREATIVE STUDIO - script.js
...
(function () {
  ...
  // Default to the first tab, or the category from the URL hash (homepage cards).
  var fromHash = (window.location.hash || '').replace('#', '');
  if (!fromHash || !activate(fromHash)) {
    activate(tabs[0].getAttribute('data-cat'));
  }
})();
